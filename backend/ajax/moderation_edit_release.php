...
// 1. Strictly verify the user is logged in as Moderator or Superadmin [1.1.1]
...
// 3. Compile metadata update block [1]
$update_data = [
    'title' => $title,
...
// 4. Update track ISRCs if provided [1]
...
// 5. FETCH USER EMAIL AND TRIGGER EMAILJS/SMTP NOTIFICATION [1, 2]
